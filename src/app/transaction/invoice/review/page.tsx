      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-100">
            <div>
              <span className="text-xs font-bold uppercase tracking-wider text-[#32A05F]">Escrow Milestone Invoice</span>
              <h1 className="text-2xl font-bold text-slate-900 mt-1">INV-2026-9824</h1>
              <p className="text-xs text-slate-400">Created Sep 08, 2026 • Status: Ready to Fund</p>
            </div>
            <div className="text-right">
              <span className="text-xs text-slate-400 uppercase font-semibold">Total Invoice Amount</span>
              <div className="text-3xl font-extrabold text-slate-900">₦500,000</div>
            </div>
          </div>

          <div className="grid grid-cols-2 gap-6 text-sm">
            <div>
              <span className="text-xs text-slate-400 uppercase font-semibold">Issued By (Seller)</span>
              <p className="font-bold text-slate-900 mt-1">Lanre Balogun</p>
              <p className="text-xs text-slate-500">lanre@paytrust.io</p>
            </div>
            <div>
              <span className="text-xs text-slate-400 uppercase font-semibold">Billed To (Buyer)</span>
          ...
          <div>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-between">
              <div>
                <p className="font-semibold text-slate-900 text-sm">Milestone 1: Project Architecture & Wireframes</p>
                <p className="text-xs text-slate-400 mt-0.5">Due Date: Sep 20, 2026</p>
              </div>
