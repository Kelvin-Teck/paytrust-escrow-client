...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white text-slate-900 selection:bg-[#EBF7F0] selection:text-[#32A05F]">
      ...
      <section className="relative pt-16 pb-20 md:pt-24 md:pb-28 overflow-hidden bg-gradient-to-b from-[#F8FAFC] to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              Eliminate the risk factor of buying and selling. Funds remain
              locked securely in trust until both parties approve delivery.
            </motion.p>
          ...
          >
            ...
            <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm hover:border-[#32A05F]/40 transition-all space-y-4">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                "I want to make more sales, but I only do payment before
                delivery." With PayTrust, buyers fund escrow upfront so you can
                deliver with 100% confidence.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm hover:border-[#32A05F]/40 transition-all space-y-4">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                "I'd love to buy this item, but I only do payment on delivery."
                Funds are only released to the vendor once you verify and
                approve the goods.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-gradient-to-br from-[#0F172A] to-[#1E293B] text-white shadow-xl space-y-4 relative overflow-hidden">
              ...
              <p className="text-sm text-slate-300 leading-relaxed">
                Risk is completely eliminated. Real-time milestones, dispute
                mediation, and multi-currency wallets ensure mutual trust for
                every deal.
              </p>
            </div>
          </motion.div>
      ...
      <section
        id="features"
        className="py-20 bg-[#F8FAFC] border-t border-slate-200"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">
                Milestone Escrow Deals
              </h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                Structure large projects or supply agreements into bite-sized
                milestones. Release payments progressively upon verified
                inspection.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">
                Multi-Currency (NGN & BTC)
              </h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                Fund wallets with Nigerian Naira via instant Paystack transfer
                or Bitcoin SegWit on-chain deposits with automated conversion.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">
                Instant Invoicing & Links
              </h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                Generate professional escrow invoices and share direct links
                with clients for immediate counter-party funding.
              </p>
            </div>
          </div>
        </div>
